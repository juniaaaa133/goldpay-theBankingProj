  ...
  return (
    ...
    <div className="ln-ctn">
        ...
        <div className="ln-form-ctn">
            <div className="su-form bg-sec">
            <div className="inp-ctn">
<input type="text" placeholder='Full Name' className="inp main-f w-[80%] text-[14px] font-[600]" />
</div>
<div className="inp-ctn">
...
<button className="btn1 bcu trans">Sign up</button>
</div>
<div className="ln-sign-ctn">
<div className="ln-sign fontcl main-f ">Aleady have an account ?</div>
<Link href='/login' className='fontcl2  main-f'>Login</Link>
</div>
            </div>
        </div>
